...
class EnvSettings:
    def __init__(self):
        self.results_path = '/root/test/pytracking/pytracking/tracking_results/'     # Where to store tracking results 
        self.network_path = '/root/test/pytracking/pytracking/networks/'     # Where tracking networks are stored.
        self.got10k_path = ''
        self.lasot_path = ''
        self.mobiface_path = ''
        self.nfs_path = ''
        self.otb_path = '/root/pytracking/pytracking/dataset/otb'
        self.tpl_path = ''
